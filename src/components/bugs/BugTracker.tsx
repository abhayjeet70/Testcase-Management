...
export default function BugTracker({ projects, selectedProjectId, testCases = [], onSaveTestCase }: BugTrackerProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-white rounded-2xl shadow-sm border border-[#E7D6C4] overflow-hidden">
      ...
      {/* Header */}
      <div className="px-4 md:px-6 py-4 md:py-5 border-b border-[#E7D6C4] flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-[#FFF4E8]/30">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <div className="relative flex-1 md:flex-none">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 border border-[#E7D6C4] rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#8B5A2B]/20 w-full md:w-64"
            />
          </div>
      ...
      {/* Main Content Area */}
      <div className="flex-1 overflow-hidden bg-[#FFF8F2]/30 p-2 md:p-6">
        <BugKanban 
